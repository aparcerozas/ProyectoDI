...
class GridWindow(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.btnAñadir = Gtk.Button("Añadir")
        self.btnAñadir.connect("clicked", self.on_buttonAñadir_clicked)
        self.btnVolver = Gtk.Button("Volver")
        self.btnVolver.connect("clicked", self.on_buttonVolver_clicked)
    ...
    def cargarInterface(self):
        ...
        self.gridProductos.attach_next_to(self.btnAñadir, self.labelPrecio, Gtk.PositionType.BOTTOM, 1, 1)
        self.gridProductos.attach_next_to(self.btnVolver, self.btnAñadir, Gtk.PositionType.RIGHT, 1, 1)
